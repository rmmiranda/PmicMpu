/********************************************************************
 *
 * System register and bit definitions for Maxim MAXQ.
 *
...
__no_init volatile __io union
{
  ...
  {
    unsigned char              : 4;
    unsigned char PULRF        : 1;
    unsigned char PULWF        : 1;
    unsigned char PSYRF        : 1;
    unsigned char PSYWF        : 1;
 } PRIVF_bit;
} @ _M(8,11);
...
__no_init volatile __io union
{
  ...
  {
    unsigned short                : 1;
    unsigned short PWL            : 1;
    unsigned short ROD            : 1;
    unsigned short UPA            : 1;
    unsigned short CDA0           : 1;
    unsigned short CDA1           : 1;
    unsigned short                : 1;
    unsigned short TAP            : 1;
    unsigned short PWLS           : 1;
    unsigned short PWLL           : 1;

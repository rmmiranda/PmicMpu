...
#define LDO1_STARTS_SETTING ( LDOSM_DCHG_EN | LVLDO_1V200 )    // LVLDO V1_2OPT
...
#define LDO7_STARTS_SETTING ( LDOSM_DCHG_EN | GPLDO_2V950 )    // GPLDO V2_95AUD
...
#define LDO11_STARTS_SETTING ( LDOSM_DCHG_EN | HVLDO_2V80 )    // HVLDO - V2_7ANT - set to 2.8 for Davis, but only needed for Or gate change
...
// Need to toggle LDO11 on BWF_26M_EN transitions - controls ISR registration
#define BWF_26M_EN_SUPPLY       { PMIC_EN_CMD2, CMD2_EN_LDO11, BWF_26M_EN}

...
#define PLATFORM_SUPPLY_SEQUENCE                               \
	...
	{ 213, PMIC_EN_CMD1, CMD1_EN_LDO1 , 0 },                   \
...
// Bluetooth/Wifi/Gps supply
#define GPS_WBF_TCXO_EN_SUPPLY  { PMIC_EN_CMD2, CMD2_EN_LDO12, GPS_WBF_TCXO_EN }
// TX_ACTIVITY FPWM mode supply
#define TX_ACTIVITY_EN_SUPPLY   { PMIC_BUCKCTRL, PMIC_BUCKCTRL_SM2_FPWM, TX_ACTIVITY }
// RX_ACTIVITY FPWM mode supply
#define RX_ACTIVITY_EN_SUPPLY   { PMIC_BUCKCTRL, PMIC_BUCKCTRL_SM2_FPWM, RX_ACTIVITY }

...
#define PLATFORM_SUPPLY_SEQUENCE                               \
    ...
    { 196, PMIC_EN_CMD0, CMD0_EN_SM0  , 0 },                   \
    { 196, PMIC_EN_CMD1, CMD1_EN_LDO1 , 0 },                   \
    { 213, GPIO_SEQ_EN, CORE_SW_EN  , 0 },                     \
    { 278, GPIO_SEQ_EN, RST_1V8_N  , 0 }            // eMMC reset
...
#define CMD1_WARM_RESET_MASK  ( CMD1_EN_LDO0 | CMD1_EN_LDO1 | CMD1_EN_LDO3 | CMD1_EN_LDO4 | CMD1_EN_LDO5  )
...
#define SM1_STARTS_SETTING ( LDOSM_DCHG_EN | SM1_1V800 )       // SM1

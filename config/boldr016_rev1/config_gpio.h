...
#define RESET_OUT_N                 PAD_PORT_2_4        // RESET_OUT_N          // what is this signal?
...
#define ROCKET_CAN_TEMP             PAD_PORT_3_1        // 47k
#define WB_PA_TEMP                  PAD_PORT_3_2        // WB_PA_TEMP
#define GPS_TEMP                    PAD_PORT_3_3        // GPS_TEMP
#define MG_CAN_TEMP                 PAD_PORT_3_4        // 47k
#define AUD_PA_TEMP                 PAD_PORT_3_5        // 47k
#define RF_TRANSCEIVER_TEMP         PAD_PORT_3_6        // 47k

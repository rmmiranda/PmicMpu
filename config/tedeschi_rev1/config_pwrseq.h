...
#define PLATFORM_SUPPLY_SEQUENCE                                 \
    ...
    { MS_TO_RTC_TICKS(6.0),  PMIC_EN_CMD1, CMD1_EN_LDO2,   0 },                    \
...
#define LDO8_STARTS_SETTING ( LDOSM_DCHG_EN | GPLDO_1V100 )    // GPLDO     // V1_1COMMS
#define LDO9_STARTS_SETTING (                 GPLDO_1V700 )    // GPLDO     // V1_7EFUSE
#define LDO10_STARTS_SETTING ( LDOSM_DCHG_EN | HVLDO_3V10 )    // HVLDO     // V3_1VIB

 ...
 * Created:     May 5, 2009
 *
 * Description: Definitions for rockets register
 ****************************************************************************/
#ifndef __ROCKET_REGISTERS_H__
#define __ROCKET_REGISTERS_H__
...
// Bits 2-5 (rw) Specifies ADC channel being measured by engine
// Bits 6-7      Reserved
...
#undef BUGBUILD_ENUM                 // RocketAdcRegAddr
  ...
  #define ADC_CONFIG0_CHANNEL_MASK      ( ADC_CONFIG0_CHANNEL(0x0F) )
#define BUGBUILD_ENUM                  "RocketAdcRegChannel"
  #define ADC_CHANNEL_MUX               0x0      // channel A0 is used for the mux
  #define ADC_CHANNEL_A1                0x1
  #define ADC_CHANNEL_A2                0x2
  #define ADC_CHANNEL_A3                0x3
  #define ADC_CHANNEL_A4                0x4
  #define ADC_CHANNEL_A5                0x5
  #define ADC_CHANNEL_A6                0x6
  #define ADC_CHANNEL_A7                0x7
  #define ADC_CHANNEL_VEREF             0x8
  #define ADC_CHANNEL_VREF_VEREF        0x9
  #define ADC_CHANNEL_TEMPDIODE         0xA
  #define ADC_CHANNEL_HALF_VCC          0xB
  #define ADC_CHANNEL_A12               0xC
  #define ADC_CHANNEL_A13               0xD
  #define ADC_CHANNEL_A14               0xE
  #define ADC_CHANNEL_A15               0xF
#undef BUGBUILD_ENUM                 // RocketAdcRegChannel
...
#undef BUGBUILD_ENUM                 // RocketAdcRegAddr
#define BUGBUILD_ENUM                   "RocketAdcRegMuxChannel"
  #define ADC_MUXCHANNEL_GND             0
  #define ADC_MUXCHANNEL_VUSB            1
  #define ADC_MUXCHANNEL_VAC             2
  #define ADC_MUXCHANNEL_VPWR            3
  #define ADC_MUXCHANNEL_VBAT            4
  #define ADC_MUXCHANNEL_VSYS            5
  #define ADC_MUXCHANNEL_VTS             6
  #define ADC_MUXCHANNEL_VCHGR_TEMP      7
  #define ADC_MUXCHANNEL_VRED            8
  #define ADC_MUXCHANNEL_VGRN            9
  #define ADC_MUXCHANNEL_VBLU            10
  #define ADC_MUXCHANNEL_VFLASHSRC       11
  #define ADC_MUXCHANNEL_VLEDM_COL0      12
  #define ADC_MUXCHANNEL_VLEDM_COL1      13
  #define ADC_MUXCHANNEL_VLEDM_COL2      14
  #define ADC_MUXCHANNEL_VLEDM_COL3      15
#undef BUGBUILD_ENUM                  // RocketAdcRegMuxChannel
...
#undef BUGBUILD_ENUM                 // RocketAdcRawRegAddr
  ...
  #define ADC_RAW_CONFIG0_CHANNEL_MASK      ( ADC_RAW_CONFIG0_CHANNEL(0x0F) )

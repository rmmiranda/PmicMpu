/****************************************************************************/
/* LNKX.CMD - V3.0.0  COMMAND FILE FOR LINKING MSP430X PROGRAMS             */
/*                                                                          */
/*   Usage:  cl430 -vmspx <src files> -z -o <out file>                      */
/*                                       -m <map file> lnkx.cmd             */
/*                                                                          */
...
/*                                                                          */
/*   Notes: (1)   You must specify the directory in which rts430x.lib is    */
/*                located.  Either add a "-i<directory>" line to this       */
/*                file, or use the system environment variable C_DIR to     */
/*                specify a search path for libraries.                      */
/*                                                                          */
/*          (2)   If the run-time support library you are using is not      */
/*                named rts430x.lib, be sure to use the correct name here.  */
/*                                                                          */
/****************************************************************************/
